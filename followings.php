...
$requests = $k->requests();
$followings = $k->db->query("SELECT * FROM users JOIN requests ON requests.to_user = users.id AND requests.from_user = $user_id")->fetch_all(true);
?>
